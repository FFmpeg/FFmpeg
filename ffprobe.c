...
#include "cmdutils_common_opts.h"
    ...
    { "-sdt",         OPT_BOOL, {(void*)&do_show_data}, "same as show_data" },
    { "show_error",   0, {(void*)&opt_show_error},  "show probing error" },
    { "ser",          0, {(void*)&opt_show_error},  "same as show_error" },
    { "show_format",  0, {(void*)&opt_show_format}, "show format/container info" },
    { "sfm",          0, {(void*)&opt_show_format}, "same as show_format" },
    { "show_frames",  0, {(void*)&opt_show_frames}, "show frames info" },
    { "sfr",          0, {(void*)&opt_show_frames}, "same as show_frames" },
    { "show_format_entry", HAS_ARG, {.func_arg = opt_show_format_entry},
      "show a particular entry from the format/container info", "entry" },
    { "sfe",               HAS_ARG, {.func_arg = opt_show_format_entry},
      "same as show_format_entry",                              "entry" },
    { "show_entries", HAS_ARG, {.func_arg = opt_show_entries},
      "show a set of specified entries", "entry_list" },
    { "set",          HAS_ARG, {.func_arg = opt_show_entries},
      "same as show_entries",            "entry_list" },
    { "show_packets", 0, {(void*)&opt_show_packets}, "show packets info" },
    { "spe",          0, {(void*)&opt_show_packets}, "same as show_packets" },
    { "show_programs", 0, {(void*)&opt_show_programs}, "show programs info" },
    { "spg",           0, {(void*)&opt_show_programs}, "same as show_programs" },
    { "show_streams", 0, {(void*)&opt_show_streams}, "show streams info" },
    { "sst",          0, {(void*)&opt_show_streams}, "same as show_streams" },
    { "show_chapters", 0, {(void*)&opt_show_chapters}, "show chapters info" },
    { "sct",           0, {(void*)&opt_show_chapters}, "same as show_chapters" },
