...
OBJS-$(CONFIG_FLV_ENCODER)             += mpegvideo_enc.o h263.o
OBJS-$(CONFIG_FOURXM_DECODER)          += 4xm.o
OBJS-$(CONFIG_FRAPS_DECODER)           += fraps.o
OBJS-$(CONFIG_GIF_DECODER)             += gifdec.o lzw.o
OBJS-$(CONFIG_GIF_ENCODER)             += gif.o
OBJS-$(CONFIG_H261_DECODER)            += h261dec.o h261.o
OBJS-$(CONFIG_H261_ENCODER)            += h261enc.o h261.o mpegvideo_enc.o
OBJS-$(CONFIG_H263_DECODER)            += h263dec.o h263.o
OBJS-$(CONFIG_H263I_DECODER)           += h263dec.o h263.o
OBJS-$(CONFIG_H263_ENCODER)            += mpegvideo_enc.o h263.o
OBJS-$(CONFIG_H263P_ENCODER)           += mpegvideo_enc.o h263.o
...
OBJS-$(CONFIG_LJPEG_ENCODER)           += ljpegenc.o mjpegenc.o mjpeg.o mpegvideo_enc.o
OBJS-$(CONFIG_LOCO_DECODER)            += loco.o golomb.o
OBJS-$(CONFIG_MACE3_DECODER)           += mace.o
OBJS-$(CONFIG_MACE6_DECODER)           += mace.o
OBJS-$(CONFIG_MJPEG_DECODER)           += mjpegdec.o mjpeg.o
OBJS-$(CONFIG_MJPEG_ENCODER)           += mjpegenc.o mjpeg.o mpegvideo_enc.o
...
OBJS-$(CONFIG_MPEG1VIDEO_ENCODER)      += mpeg12enc.o mpeg12data.o mpegvideo_enc.o
OBJS-$(CONFIG_MPEG2VIDEO_ENCODER)      += mpeg12enc.o mpeg12data.o mpegvideo_enc.o
OBJS-$(CONFIG_MPEG4_DECODER)           += h263dec.o h263.o
OBJS-$(CONFIG_MPEG4_ENCODER)           += mpegvideo_enc.o h263.o
OBJS-$(CONFIG_MSMPEG4V1_DECODER)       += msmpeg4.o msmpeg4data.o h263dec.o h263.o
OBJS-$(CONFIG_MSMPEG4V1_ENCODER)       += msmpeg4.o msmpeg4data.o mpegvideo_enc.o h263.o
OBJS-$(CONFIG_MSMPEG4V2_DECODER)       += msmpeg4.o msmpeg4data.o h263dec.o h263.o
OBJS-$(CONFIG_MSMPEG4V2_ENCODER)       += msmpeg4.o msmpeg4data.o mpegvideo_enc.o h263.o
OBJS-$(CONFIG_MSMPEG4V3_DECODER)       += msmpeg4.o msmpeg4data.o h263dec.o h263.o
OBJS-$(CONFIG_MSMPEG4V3_ENCODER)       += msmpeg4.o msmpeg4data.o mpegvideo_enc.o h263.o
...
OBJS-$(CONFIG_RV10_ENCODER)            += rv10.o mpegvideo_enc.o h263.o
OBJS-$(CONFIG_RV20_DECODER)            += rv10.o h263.o
OBJS-$(CONFIG_RV20_ENCODER)            += rv10.o mpegvideo_enc.o h263.o
...
OBJS-$(CONFIG_SNOW_ENCODER)            += snow.o rangecoder.o h263.o
...
OBJS-$(CONFIG_SVQ1_ENCODER)            += svq1enc.o svq1.o h263.o
...
OBJS-$(CONFIG_WMV1_ENCODER)            += mpegvideo_enc.o h263.o
OBJS-$(CONFIG_WMV2_DECODER)            += msmpeg4.o msmpeg4data.o h263dec.o h263.o
OBJS-$(CONFIG_WMV2_ENCODER)            += msmpeg4.o msmpeg4data.o mpegvideo_enc.o h263.o
