...
bool configGenerator::outputConfig( )
{
    ...
    ulFindPos = sHeader2.find("/*", ulFindPos+2);
    sHeader2.replace(ulFindPos, 2, ";******");
...
void configGenerator::getFileHeader( string & sHeader )
{
    sHeader += "/* Automatically generated by SMP project_generate - do not modify! */\n";
    sHeader += "/*\n\
