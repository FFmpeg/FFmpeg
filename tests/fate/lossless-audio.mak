...
FATE_SAMPLES_LOSSLESS_AUDIO-$(call DEMDEC, RM, RALF, ARESAMPLE_FILTER) += fate-ralf
fate-ralf: CMD = md5 -i $(TARGET_SAMPLES)/lossless-audio/luckynight-partial.rmvb -vn -f s16le -af aresample

FATE_SAMPLES_LOSSLESS_AUDIO-$(call DEMDEC, SHORTEN, SHORTEN, ARESAMPLE_FILTER) += fate-lossless-shorten
fate-lossless-shorten: CMD = md5 -i $(TARGET_SAMPLES)/lossless-audio/luckynight-partial.shn -f s16le -af aresample

FATE_SAMPLES_LOSSLESS_AUDIO-$(call DEMDEC, RKA, RKA, ARESAMPLE_FILTER) += fate-lossless-rka
